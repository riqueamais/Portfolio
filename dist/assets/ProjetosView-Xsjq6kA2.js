import{r as le,o as Ir,c as br,a as Ft,b as Y,d as K,e as S,t as Bt,f as Q,g as Sr,F as at,h as Wt,w as ne}from"./index-YPwgV4ii.js";var Xn={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qe{constructor(e){this.initTransports_(e)}static get ALL_TRANSPORTS(){return[Ee,$]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}initTransports_(e){const t=$&&$.isAvailable();let s=t&&!$.previouslyFailed();if(e.webSocketOnly&&(t||U("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),s=!0),s)this.transports_=[$];else{const i=this.transports_=[];for(const r of qe.ALL_TRANSPORTS)r&&r.isAvailable()&&i.push(r);qe.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}qe.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var j;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(j||(j={}));function Vi(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function kn(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Dn(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vt{constructor(e,t,s){this.path=e,this.affectedTree=t,this.revert=s,this.type=j.ACK_USER_WRITE,this.source=Vi()}operationForChild(e){if(v(this.path)){if(this.affectedTree.value!=null)return f(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new w(e));return new vt(C(),t,this.revert)}}else return f(y(this.path)===e,"operationForChild called for unrelated child."),new vt(b(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qe{constructor(e,t){this.source=e,this.path=t,this.type=j.LISTEN_COMPLETE}operationForChild(e){return v(this.path)?new Qe(this.source,C()):new Qe(this.source,b(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pe{constructor(e,t,s){this.source=e,this.path=t,this.snap=s,this.type=j.OVERWRITE}operationForChild(e){return v(this.path)?new pe(this.source,C(),this.snap.getImmediateChild(e)):new pe(this.source,b(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xe{constructor(e,t,s){this.source=e,this.path=t,this.children=s,this.type=j.MERGE}operationForChild(e){if(v(this.path)){const t=this.children.subtree(new w(e));return t.isEmpty()?null:t.value?new pe(this.source,C(),t.value):new Xe(this.source,C(),t)}else return f(y(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Xe(this.source,b(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class q{constructor(e){this.writeTree_=e}static empty(){return new q(new T(null))}}function He(n,e,t){if(v(e))return new q(new T(t));{const s=n.writeTree_.findRootMostValueAndPath(e);if(s!=null){const i=s.path;let r=s.value;const o=F(i,e);return r=r.updateChild(o,t),new q(n.writeTree_.set(i,r))}else{const i=new T(t),r=n.writeTree_.setTree(e,i);return new q(r)}}}function Ns(n,e,t){let s=n;return W(t,(i,r)=>{s=He(s,A(e,i),r)}),s}function Rs(n,e){if(v(e))return q.empty();{const t=n.writeTree_.setTree(e,new T(null));return new q(t)}}function un(n,e){return ye(n,e)!=null}function ye(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(F(t.path,e)):null}function As(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(N,(s,i)=>{e.push(new g(s,i))}):n.writeTree_.children.inorderTraversal((s,i)=>{i.value!=null&&e.push(new g(s,i.value))}),e}function re(n,e){if(v(e))return n;{const t=ye(n,e);return t!=null?new q(new T(t)):new q(n.writeTree_.subtree(e))}}function dn(n){return n.writeTree_.isEmpty()}function De(n,e){return Gi(C(),n.writeTree_,e)}function Gi(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let s=null;return e.children.inorderTraversal((i,r)=>{i===".priority"?(f(r.value!==null,"Priority writes must always be leaf nodes"),s=r.value):t=Gi(A(n,i),r,t)}),!t.getChild(n).isEmpty()&&s!==null&&(t=t.updateChild(A(n,".priority"),s)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oc{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function dr(n,e){let t=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();t!==null&&!Sn(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(i)}t&&n.eventLists_.push(t)}function fr(n,e,t){dr(n,t),_r(n,s=>Sn(s,e))}function ve(n,e,t){dr(n,t),_r(n,s=>G(s,e)||G(e,s))}function _r(n,e){n.recursionDepth_++;let t=!0;for(let s=0;s<n.eventLists_.length;s++){const i=n.eventLists_[s];if(i){const r=i.path;e(r)?(Mc(n.eventLists_[s]),n.eventLists_[s]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function Mc(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const s=t.getEventRunner();de&&M("event: "+t.toString()),nt(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ie(uh,dh,"app");const fh={apiKey:"AIzaSyDnXAZ7FDKa0unHVHyCOvIrtjPqoEu_yJw",authDomain:"riqueamais.firebaseapp.com",projectId:"riqueamais",storageBucket:"riqueamais.appspot.com",messagingSenderId:"248697483662",appId:"1:248697483662:web:8a9757ec7add013b6cf4df",measurementId:"G-16Z8L175X9"},_h=ii(fh),ph=S("section",{"data-aos":"fade-right",class:"projetos-search"},[S("div",{class:"container"},[S("div",{class:"row"},[S("div",{class:"col-12 d-flex flex-column mb-5"},[S("h2",null,"Projetos"),S("p",null,"Aqui estão meus principais projetos.")])])])],-1),mh={class:"projetos"},gh={class:"container"},yh={class:"row"},vh={class:"col-xl-10 col-md-11 col-sm-10 col-11 mt-0 mb-4"},Ch={class:"type"},Eh={class:"col-xl-2 col-md-1 col-sm-2 col-1 d-flex justify-content-end mb-4"},wh={key:0,class:"dropdown-content"},Ih={key:0,class:"container"},bh={class:"row"},Sh={key:1,class:"container"},Th={class:"row"},Nh={class:"background"},Rh=["href"],Ah=["src","alt"],kh={class:"d-flex"},Dh=["src","alt"],xh={class:"m-0"},Oh={__name:"ProjetosView",setup(n){const e=le(4),t=le(!1),s=le("pi pi-angle-down"),i=le(""),r=le("All"),o=le([]),a=le(!0),l=lh(_h),c=Zc(l,"projetos");(()=>{setTimeout(()=>{$s(c,D=>{const R=D.val();R&&(o.value=Object.values(R),a.value=!1)})},2e3)})(),Ir(()=>{$s(c,D=>{const R=D.val();R&&(e.value=Object.values(R).length)})});const h=()=>{window.innerWidth<=991&&(t.value=!t.value,s.value=t.value?"pi pi-angle-down rotated":"pi pi-angle-down back-rotated")},d=()=>{window.innerWidth>991&&(t.value=!0,s.value="pi pi-angle-down rotated")},_=()=>{window.innerWidth>991&&(t.value=!1,s.value="pi pi-angle-down back-rotated")},p=D=>{r.value=D,t.value=!1,s.value="pi pi-angle-down back-rotated"},E=br(()=>{const D=i.value.toLowerCase().trim();return o.value.filter(z=>{const V=z.name.toLowerCase().includes(D),ot=r.value==="All"||z.type===r.value;return V&&ot})}),k=D=>D?D.split(",").map(z=>z.trim().toLowerCase()):[];return(D,R)=>{const z=Ft("PrimeVueButton"),V=Ft("Skeleton"),ot=Ft("Card");return Y(),K(at,null,[ph,S("section",mh,[S("div",gh,[S("div",yh,[S("div",vh,[S("h2",Ch,Bt(r.value),1)]),S("div",Eh,[S("div",{class:"dropdown-container",onMouseover:d,onMouseleave:_},[Q(z,{label:"Filtrar",class:"filter",icon:s.value,iconPos:"right",onClick:h},null,8,["icon"]),t.value?(Y(),K("div",wh,[S("ul",null,[S("li",{onClick:R[0]||(R[0]=H=>p("All"))},"All"),S("li",{onClick:R[1]||(R[1]=H=>p("Sites"))},"Sites"),S("li",{onClick:R[2]||(R[2]=H=>p("Landing Pages"))},"LP's")])])):Sr("",!0)],32)]),a.value?(Y(),K("div",Ih,[S("div",bh,[(Y(!0),K(at,null,Wt(e.value,H=>(Y(),K("div",{key:H,class:"col-xl-6 col-lg-6 col-12 mb-5"},[Q(ot,{class:"mb-3 card"},{header:ne(()=>[Q(V,{class:"background",height:"320px"})]),title:ne(()=>[Q(V,{width:"210px"})]),subtitle:ne(()=>[Q(V,{width:"120px"})]),content:ne(()=>[Q(V,{width:"100%",class:"mb-3"}),Q(V,{width:"90%",class:"mb-3"}),Q(V,{width:"75%",class:"mb-3"}),Q(V,{width:"170px",class:"mb-3"})]),_:1})]))),128))])])):(Y(),K("div",Sh,[S("div",Th,[(Y(!0),K(at,null,Wt(E.value,H=>(Y(),K("div",{key:H.name,class:"col-xl-6 col-lg-6 col-12 mb-5","data-aos":"zoom-in"},[Q(ot,{class:"mb-3 card"},{header:ne(()=>[S("div",Nh,[S("a",{href:H.link,target:"_blank"},[S("img",{src:H.photo,alt:H.name,loading:"lazy"},null,8,Ah)],8,Rh)])]),title:ne(()=>[S("h3",null,Bt(H.name),1)]),subtitle:ne(()=>[S("div",kh,[(Y(!0),K(at,null,Wt(k(H.icons),Lt=>(Y(),K("img",{class:"icons",key:Lt,src:`${Lt}`,alt:Lt},null,8,Dh))),128))])]),content:ne(()=>[S("p",xh,Bt(H.description),1)]),_:2},1024)]))),128))])]))])])])],64)}}};export{Oh as default};
